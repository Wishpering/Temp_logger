...
try:
    with open(Path + "configs/config.json", "r") as config_File:
...
while True:
    try:
        ...
        print((str(datetime.now()).split('.'))[0], "Температура = " + temperature + " ℃" + "  Влажность = " + humidity + " %")
